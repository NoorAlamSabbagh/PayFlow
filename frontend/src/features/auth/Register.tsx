...
export const Register: React.FC = () => {
  ...
  return (
    <div className="auth-split-layout">
      {/* Left Panel: 3D Fintech Showcase */}
        ...
        <div style={{ margin: '2.5rem 0', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.85rem', fontWeight: 800, color: 'var(--text-primary)', lineHeight: 1.25 }}>
              Open your high-reliability digital wallet account.
            </h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.925rem', marginTop: '0.5rem', lineHeight: 1.6 }}>
              Instant provisioning of INR currency wallets with stateful token security and immutable transaction audit trails.
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
            <div style={{ padding: '0.85rem', borderRadius: 'var(--radius-md)', backgroundColor: 'rgba(15, 23, 42, 0.6)', border: '1px solid var(--border-subtle)' }}>
      ...
      <div className="auth-form-panel">
        <div style={{ width: '100%', maxWidth: '420px' }}>
          <div style={{ marginBottom: '1.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
              <span className="badge badge-primary" style={{ gap: '0.25rem' }}>
                <ShieldCheck size={12} /> New Account
              </span>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', marginTop: '0.35rem' }}>
              Join the PayFlow digital wallet and processing platform.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
            ...
            <div className="input-group">
              <label className="input-label" htmlFor="register-password-input">Password (Min 8 chars, 1 uppercase, 1 number)</label>
              <div className="input-wrapper">
            ...
            <div className="input-group">
              <label className="input-label" htmlFor="role-select">Account Role (Portfolio Demo)</label>
              <select
                id="role-select"
              ...
              >
                <option value="USER">USER (Standard Consumer Wallet)</option>
